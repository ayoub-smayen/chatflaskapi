...
PUSHER_APP_ID="925887"
PUSHER_KEY="1a3058f3c8521c9d6662"
PUSHER_SECRET="9e9915eb756f27a76bae"
PUSHER_CLUSTER="eu"
...
app.config['JWT_SECRET_KEY'] = 'jbjbfjfbhjfbfhb'  # Change this!
...
def request_chat():
    ...
    channel = Channel.query.filter(Channel.from_user.in_([from_user, to_user])).filter(Channel.to_user.in_([from_user, to_user])).first()
    if not channel:
        # Generate a channel...
